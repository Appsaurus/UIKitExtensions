...
//            let top = border()
//            addSubview(top)
//            top.autoPinToSuperview(excludingEdges: [.bottom], withInsets: UIEdgeInsets.init(horizontalPadding: padding))
//            borders.append(top)
//        }
//        
...
//            let left = border()
//            addSubview(left)
//            left.autoPinToSuperview(excludingEdges: [.right], withInsets: UIEdgeInsets.init(verticalPadding: padding))
//            borders.append(left)
//        }
//        
...
//            let right = border()
//            addSubview(right)
//            right.autoPinToSuperview(excludingEdges: [.left], withInsets: UIEdgeInsets.init(verticalPadding: padding))
...
//            let bottom = border()
//            addSubview(bottom)
//            bottom.autoPinToSuperview(excludingEdges: [.top], withInsets: UIEdgeInsets.init(horizontalPadding: padding))
//            borders.append(bottom)
//        }
//        borders.forEach { (b) in
//            b.autoSizeHeight(to: thickness)
//        }
//        return borders
//    }
